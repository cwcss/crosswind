...
```### 3. Gitignore Generated CSS```gitignore
...
Include all files that contain utility classes:```typescript
const config = {
  content: [
...
Use computed properties for dynamic classes:```vue
<script setup>
